...
//     // console.log('00000000001:' + doc.page.width);
//     // console.log('00000000001:' + doc.page.height);
//     // console.log('00000000001:' + doc.page.margins.left);
//     // console.log('00000000001:' + doc.page.margins.right);
//     // console.log('00000000001:' + doc.page.margins.top);
//     // console.log('00000000001:' + doc.page.margins.bottom);
...
function generatePDF(data, outputPath, callback) {
  ...
  data.elements.forEach((element, index) => {
    ...
    if (displayText) {
      ...
      xCentered = marginLeft + (contentWidth - textWidth) / 2;
      if (linkable) {
        doc.font('ARIALBD').fontSize(intro.sizeTitle);
        let textHeight = doc.heightOfString(`${index}-${title}`, {
          width: textWidth,
          align: 'center',
          lineGap: 3,
      ...
      content = addParagraph(content);
      content = sanitize(content);
      doc.font('ARIAL').fontSize(intro.sizeText);
      textHeight += doc.heightOfString(`${content}`, {
        width: 500, align: 'left', lineGap: 3,
      });
      lineHeight = doc.currentLineHeight();
