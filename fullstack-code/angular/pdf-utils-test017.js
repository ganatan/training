...
function generatePDF(data, outputPath, callback) {
  ...
  //   lineGap: lineGap,
  // });
  // if (doc.y + textHeight > contentHeight) {
  //   doc.addPage();
  // }
  ...
  doc.fillColor('black')
    .text(`DEFAULT Line 00000000000000000000000000`, 50, doc.y, {
  ...
  doc.font('ARIAL').fontSize(14);
  doc.fillColor('black')
    .text(`A4 Line 00000000000000000000000000`, 50, doc.y, {
      width: 500, align: 'left', lineGap: 3,
    });
  ...
  data.elements.forEach((element, index) => {
    ...
    if (displayText) {
      ...
      doc.font('ARIAL').fontSize(14);
      let textHeight = doc.heightOfString(`${index}-text`, xCentered, doc.y, {
        width: textWidth,
        align: 'center',
        lineGap: 3,
      });
      ...
      doc.fillColor('red')
        .text(`${index}-text`, xCentered, doc.y, {
          width: textWidth,
          align: 'center',
          lineGap: 3,
        });
      ...
      console.log('00000000003:' + contentHeight);
      console.log('00000000002:' + textHeight);
      console.log('00000000004:' + doc.y);
      while (doc.y + textHeight > contentHeight) {
        checkPageNew(doc);
        textHeight -= contentHeight;
        console.log('00000000005:' + textHeight);
      }
      doc.fillColor('black')
    ...
    if (displayChapter) {
      ...
      xCentered = marginLeft + (contentWidth - textWidth) / 2;
      doc.font('ARIAL').fontSize(14);
      textHeight = doc.heightOfString(`${index}-chapter`, xCentered, doc.y, {
        width: textWidth,
        align: 'center',
        lineGap: 3,
      });
      ...
      doc.fillColor('red')
        .text(`${index}-chapter`, xCentered, doc.y, {
          width: textWidth,
          align: 'center',
          lineGap: 3,
        });
    ...
    if (displayImage) {
      ...
      xCentered = marginLeft + (contentWidth - textWidth) / 2;
      doc.font('ARIAL').fontSize(14);
      textHeight = doc.heightOfString(`${index}-image`, xCentered, doc.y, {
        width: textWidth,
        align: 'center',
        lineGap: 3,
      });
    ...
    if (displayCode) {
      ...
      doc.fillColor('red')
        .text(`${index}-code`, xCentered, doc.y, {
          width: textWidth,
          align: 'center',
          lineGap: 3,
        });
